...
changing anything. That is deliberate, and it is the reason to pin by **digest** when you need a
reference that cannot move under you:

```bash
docker pull innovarhealthcare/bridgelink@sha256:<digest>
```
